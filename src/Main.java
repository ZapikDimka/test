...
* */
/*
* вже після здачі роботи до мене дійшло, що замість того, щоб робити масиви з декількома рівнями вкладеності
* на зробити розгалуження файлів або папок для облегшення ручної роботи з файлами,
* мені здається, що можна таке розгалуження дати тим, хто створює розклад, щоб вони напряму в нашу файли
*  вносили зміни розкладу, або писали новий розклад, у вже існуючі комірки, а наша програма
*  автоматично перероблюватиме його в ексель таблицю, це буле легше і простіше для обох сторін,
* враховуючи той факт, як створюється розклад(сам процес)
* */
